...
- 44 EditMode tests covering capture behavior and distribution safety
...
Append `#v1.0.3` to pin the latest patched release.

### Unity package

Download `Photobooth-1.0.3.unitypackage` from the matching GitHub release and
